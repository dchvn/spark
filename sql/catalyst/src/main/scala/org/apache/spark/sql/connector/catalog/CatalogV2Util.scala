...
import org.apache.spark.sql.catalyst.plans.logical.{CreateTableAsSelectStatement, CreateTableStatement, ReplaceTable, ReplaceTableAsSelectStatement, SerdeInfo}
...
private[sql] object CatalogV2Util {
  ...
  def convertTableProperties(r: ReplaceTable): Map[String, String] = {
