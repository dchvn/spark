...
import py4j.protocol  # type: ignore[import]
from py4j.protocol import Py4JJavaError  # type: ignore[import]
from py4j.java_gateway import JavaObject  # type: ignore[import]
from py4j.java_collections import JavaArray, JavaList  # type: ignore[import]
...
def _to_java_object_rdd(rdd: Any) -> JavaObject:
...
def _py2java(sc: Any, obj: Any) -> Any:
...
def _java2py(sc: Any, r: Any, encoding: str = "bytes") -> Any:
...
def callJavaFunc(sc: pyspark.context.SparkContext, func: Any, *args: Any) -> Any:
    """ Call Java Function """
    args = [_py2java(sc, a) for a in args]  # type: ignore[assignment]
